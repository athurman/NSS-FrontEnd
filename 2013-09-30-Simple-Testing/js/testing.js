...
test( "greetings", function() {
  ...
  deepEqual(greetings("Hola","Steven"), "Hola Steven", "greet a name input");
});
...
//   deepEqual( ,<actual_value>, <expected_value>, "testing this function with differente arguments" );
// });

test( "1 + 1", function() {
  deepEqual(1 + 1, 2, "addind 1 and 1");
});

test( "add_three", function() {
  deepEqual(add_three(5), 8, "add 3 to each number");
});