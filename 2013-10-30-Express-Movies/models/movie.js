...
var Movie = function(genericMovie) {
  ...
  this.grossPerTheatre = function(){return this.gross / this.numTheatres};
  this.grossUSD = function(){return '$' + mm.format('USD', mm.floatToAmount(this.gross));};
  this.grossPerTheatreUSD = function(){return '$' + mm.format('USD', mm.floatToAmount(this.grossPerTheatre()));};
};
